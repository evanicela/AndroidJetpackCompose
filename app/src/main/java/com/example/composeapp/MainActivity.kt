...
//        inside this function we can declare composable units
        ...
        Column {
            ...
            Text("Niyonizigiye", style = TextStyle(color = Color.Red, fontWeight = FontWeight.Light))
            Text("Niyonizigiye", style = TextStyle(color = Color.Red, fontSize = 20.sp))
        }
    }
...
//        inside this function we can declare composable units // widgets need meta data // unit in composable called the column composable
        Column {
            ...
            Text("Niyonizigiye", style = TextStyle(color = Color.Black))
        }
    }
